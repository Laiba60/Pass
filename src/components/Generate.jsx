          ...
          <nav className="w-full flex justify-between items-center py-4 border-b border-white">
            ...
            <div className="flex-1 items-center flex justify-end gap-4">
              <div className="relative hidden md:block border-2 border-blue-500 rounded-full bg-[#101E71] w-full max-w-[300px]">
                <img
                  src={search}
                  className="absolute top-1/2 left-3 -translate-y-1/2 w-7 h-7"
                  alt="Search"
                />
                <input
                  type="search"
              ...
              <a
                className="w-14 h-14 flex items-center justify-center bg-[#101E71] border border-[#374CC4] rounded-full"
              ...
              <a
                className="w-14 h-14 flex items-center justify-center bg-[#101E71] border border-[#374CC4] rounded-full mr-3"
                href="/dashboard/folders"
              >
        ...
        <section className="w-full container flex flex-col gap-[15px]">
          ...
          <div className="flex justify-between">
            <div
              ...
              style={{
                background:
                  "linear-gradient(90deg, rgb(161, 67, 255) 0%, rgb(80, 3, 219) 100%)",
              }}
            >
