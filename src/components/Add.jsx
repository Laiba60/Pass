  ...
  return (
    <div className="relative min-h-[100vh] bg-[#0E1A60] text-white w-screen flex flex-col ">
                  ...
                  <nav className="relative flex justify-between items-center py-[16px] mq2000:py-[24px]  gradient-border gap-[20px]">
                    ...
                    <div className="flex-1 items-center gap-[18px] flex justify-end z-[2]">
                      <div className="relative flex-1 hidden md:block">
                        ...
                        <span class="absolute right-[17px] top-[17px] cursor-pointer"><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-[10px] h-[10px] sm:w-[20px] sm:h-[20px]">
                        ...
                        <div className="gap-[5px]">
                            ...
                            <input name="foldername" className="w-full dm-sans border-[1px] mb-2 h-[38.86px] rounded-[10px] border-[#374CC4] outline-none bg-[#0E1956] py-[5px] px-[5px] placeholder:text-[#DFDFDF36] text-white text-[16px] leading-[32px] font-[400]" value=""/>
                        </div>
                        </section>
          ...
          border-none flex items-center justify-center text-[12px] sm:text-[16px] 
           font-[400] text-black">Cancel</button>
           <button 
